...
%% Change these:
\newcommand{\projecttitle}{STUDENT-MANIA}
\newcommand{\projectauthor}{Stephen Gallagher \\[0.2cm] Kevin Flanagan \\[0.2cm] Jack Haugh }
\newcommand{\projectadvisor}{Mark Campbell}
\newcommand{\projectprogramme}{Applied Project And Minor Dissertation Bachelor of Honours in Software Development}
